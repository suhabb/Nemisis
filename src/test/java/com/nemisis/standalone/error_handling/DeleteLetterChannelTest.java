...
public class DeleteLetterChannelTest extends CamelTestSupport {

    @Override
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new DeleteLetterChannelRoute();
    }

    @Test
    public void givenRoute_Delete_Letter_Queue() throws Exception {
